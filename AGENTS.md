...
```
src/
├── Controller/           # HTTP controllers, thin, focused on HTTP concerns
├── Entity/              # Doctrine entities, business objects
├── Service/             # Business logic, external integrations
├── Repository/           # Data access layer
├── Field/               # Custom EasyAdmin fields
...
Generated for agentic development excellence. 🚀
