 ...
 */
final class Version20230117124646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE song (id INT NOT NULL, title TEXT NOT NULL, date DATE DEFAULT NULL, year INT DEFAULT NULL, school VARCHAR(255) DEFAULT NULL, lyrics TEXT DEFAULT NULL, featured_artist TEXT DEFAULT NULL, recording_credits TEXT DEFAULT NULL, musicians TEXT DEFAULT NULL, writers TEXT DEFAULT NULL, wordpress_page_id INT DEFAULT NULL, recording TEXT DEFAULT NULL, publisher TEXT DEFAULT NULL, notes JSONB DEFAULT NULL, lyrics_length INT DEFAULT NULL, attributes JSONB DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE video (id INT NOT NULL, youtube_id VARCHAR(32) DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, date DATE DEFAULT NULL, raw_data JSON DEFAULT NULL, PRIMARY KEY(id))');
    }
